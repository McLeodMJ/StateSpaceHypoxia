...
colnames(DsD) <- c("Year", "Period", "Freq_sq", "Sim_DO")
...
plot(DsD[DsD$Year == 2015, 4], type='l')
...
lag1  = 0.8868  # Get this value from the ar() operation above #coefficient correlation btw successive pts
