...
Total_sp_data <- Total_sp_data[Total_sp_data$year %in% 2010:2014 & Total_sp_data$latitude_dd >= 43.8041, ] #remove year w/0 lengths
```
...
Dsole.OR.WA <- vector("list", length = 5)
...
Grock.OR.WA <- vector("list", length = 5)
...
Yrock.OR.WA <- vector("list", length = 5)
...
Ling.OR.WA <- vector("list", length = 5)
...
#save(Ling.OR.WA, Grock.OR.WA, Yrock.OR.WA, Dsole.OR.WA, file="Nact_site_yr.Rdata") 
```
