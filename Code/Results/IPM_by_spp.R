...
d <- ggplot(df[df$Type =="Dsole", ], aes(Time, Pop.Size))+
  ...
  geom_line(data =df[df$Type =="Dsole",], aes(Time, Equil), color="purple",size = 1, linetype = "dashed")+
...
l <- ggplot(df[df$Type =="Lingcod", ], aes(Time, Pop.Size))+
  ...
  geom_line(data =df[df$Type =="Lingcod",], aes(Time, Equil), color="purple",size = 1, linetype = "dashed")+
...
g <- ggplot(df[df$Type =="Grock", ], aes(Time, Pop.Size))+
  ...
  geom_line(data =df[df$Type =="Grock",], aes(Time, Equil), color="purple",size = 1, linetype = "dashed")+
...
y <- ggplot(df[df$Type =="Yrock", ], aes(Time, Pop.Size))+
  ...
  geom_line(data =df[df$Type =="Yrock",], aes(Time, Equil), color="purple",size = 1, linetype = "dashed")+
